...
const SPOTS = [
  ...
  { name: 'Lac de Serre-Ponçon', lat: 44.4997, lng: 6.3331, dept: '05', commune: 'Savines-le-Lac', water: 'LAKE' as const, cat: 'SECOND' as const, types: ['SPINNING' as const, 'BOAT' as const, 'FLOAT_TUBE' as const] },
  ...
  { name: 'Lac de Naussac', lat: 44.7333, lng: 3.8000, dept: '48', commune: 'Naussac-Fontanes', water: 'LAKE' as const, cat: 'SECOND' as const, types: ['SPINNING' as const, 'BOAT' as const, 'FLY' as const] },
  ...
  { name: 'Lac du Salagou', lat: 43.6500, lng: 3.3667, dept: '34', commune: 'Clermont-l\'Hérault', water: 'LAKE' as const, cat: 'SECOND' as const, types: ['CARP' as const, 'SPINNING' as const, 'FLOAT_TUBE' as const] },
  { name: 'Lac de Vouglans', lat: 46.5167, lng: 5.6833, dept: '39', commune: 'Orgelet', water: 'LAKE' as const, cat: 'SECOND' as const, types: ['SPINNING' as const, 'TROLLING' as const, 'BOAT' as const] },
  ...
  { name: 'Lac de Montbel', lat: 42.9333, lng: 1.8833, dept: '09', commune: 'Montbel', water: 'LAKE' as const, cat: 'SECOND' as const, types: ['CARP' as const, 'SPINNING' as const, 'BOAT' as const] },
  { name: 'Lac de Pierre-Percée', lat: 48.4500, lng: 6.9333, dept: '54', commune: 'Pierre-Percée', water: 'LAKE' as const, cat: 'FIRST' as const, types: ['FLY' as const, 'SPINNING' as const, 'BOAT' as const] },
