...
- ⏳ **Slices restantes** : **slice 4** (affichage niveau 2 carte+fiche) — utile seulement quand des ACCESS_ZONE existeront (créations utilisateurs ou ré-ingestion) ; **slice 6** (rattachement waypoint privé `PrivateSpot.spotId`, OPTIONNEL/différé, migration M2 = orchestrateur).
