...
- ⏳ **Slice restante** : **slice 6** (rattachement waypoint privé `PrivateSpot.spotId`, OPTIONNEL/différé, migration M2 = orchestrateur). Le reste du chantier est complet de bout en bout pour la donnée future.
